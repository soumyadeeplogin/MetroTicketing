...
public class Flow {
	...
	public void totalDistanceAndCost() {
		if (lineChecker() == 1) {
			...
			if ((X.getSudoName(0).getStationLine() == nonX.getStationLine())
					|| (X.getSudoName(1).getStationLine() == nonX.getStationLine())) {
				StationI xDest = ((X.getSudoName(0).getStationLine() == nonX.getStationLine()) ? X.getSudoName(0)
						: X.getSudoName(1));
